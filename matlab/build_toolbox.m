...
excludeDirs = [".git", ".github", ".spec-workflow", ".playwright-mcp", ".claude", ".vscode", ...
    "ModelandCode_EP2", "slprj", "tasks", "scripts", "test", "test-ui", ...
    "node_modules", "_verify", "_nm_bak"];
...
out = opts.OutputFile;
fprintf(['已打包: %s\n' ...
         '接收者安装后:① 运行 setupMATLABCopilot("repair");' ...
         '② 确保 Node.js ≥ 20 与 Claude/Codex CLI 可用;' ...
