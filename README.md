...
[![Version](https://img.shields.io/badge/version-0.14.3-success)](https://github.com/suzike/matlab-simulink-copilot/releases/tag/v0.14.3)
...
![Tests](https://img.shields.io/badge/sidecar-92%20tests-16a34a)
...
下面三张图由 v0.14.3 的 `ui/index.html` 在全屏浏览器预览中生成，展示与 MATLAB `uihtml` 面板相同的前端代码、布局和交互状态。

<div align="center">
  <img src="docs/images/v0.14.3-ui-overview.jpg" width="900" alt="MATLAB Copilot v0.14.3 全屏界面与中断终态">
  <br>
...
<div align="center">
  <img src="docs/images/v0.14.3-change-recorder.jpg" width="900" alt="MATLAB Copilot v0.14.3 分阶段工程模型变更记录器">
  <br>
...
<div align="center">
  <img src="docs/images/v0.14.3-mbse-workflow.jpg" width="900" alt="MATLAB Copilot v0.14.3 MBSE RFLPV 工程流程">
  <br>
...
- **Stop 确认式收尾**：点击停止后先显示“正在停止”，等待 sidecar 返回确定回执再恢复发送按钮，不再本地提前假装完成。
- **工具卡终态闭环**：中断、错误或缺少 `tool_result` 的异常收尾都会结算遗留工具卡，后台已停止时不再永久显示“运行中”。
- **空进程中断确认**：Claude Code / Codex 子进程即使已提前退出，也会回应 Stop，清除 UI 残留状态。
- **引导模式隔离**：迟到的旧轮中断回执只结算旧工具卡，不会清除新一轮的忙状态。
- **完整回归验证**：92 项 Node 测试、38 项桌面/窄屏 UI 测试和 14 项 MATLAB R2025b 测试通过，并完成真实 MATLAB `uihtml` 状态流验证。
...
<div align="center">
  <img src="docs/images/architecture.svg" width="900" alt="MATLAB Copilot v0.14.3 静态系统架构图">
</div>
...
<div align="center">
  <img src="docs/images/dataflow.svg" width="900" alt="MATLAB Copilot v0.14.3 消息数据流图">
</div>
...
<div align="center">
  <img src="docs/images/features.svg" width="900" alt="MATLAB Copilot v0.14.3 功能全景图">
</div>
...
<div align="center">
  <img src="docs/images/permission.svg" width="900" alt="MATLAB Copilot v0.14.3 权限与安全逻辑图">
</div>
...
当前主分支发布门槛包括：92 个 sidecar 测试、38 项 Playwright 桌面/窄屏回归、UI 两段脚本语法检查、MATLAB R2023b/R2025b CI、R2025b `checkcode` / 类加载与 14 项真实事务/快照/MBSE/安装辅助逻辑测试、最终 `.mltbx` 验收、SHA-256 生成和 GitHub Release 资产校验。
